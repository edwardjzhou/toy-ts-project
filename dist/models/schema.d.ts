...
export declare type PrimaryKey = number | string;
export declare type GradeGrade = `${Grade}.${Grade}`;
export declare type Model = typeof Student | typeof Test | typeof Mark | typeof Course;
export declare type Record = Student | Test | Mark | Course;
export declare type RecordForModel<M extends Model> = M extends new (...args: any[]) => infer R ? R extends Record ? R : never : never;
...
export declare type PKSchema = {
    id: PrimaryKey;
} & Schema;
export declare type NotPrimaryKeyedSchema = {
    id?: never;
} & Schema;
