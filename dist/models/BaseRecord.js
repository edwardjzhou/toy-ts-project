...
__decorate([final_1.default], BaseRecord, "all", void 0);
__decorate([measure_1.default], BaseRecord, "import", null);
      ...
      switch (this.index.has(id)) {
        ...
        case false:
          switch (this.isLoaded) {
            case true:
              throw Error(
                "relational consistency violated; some FK doesnt map to a record"
              );
            case false:
              return await new Promise((resolve) => {
                this.isLoadedEvent.on(PK_MODEL_DONE_IMPORTING, () =>
...
exports.default = {
  withoutPrimaryKey: exports.withoutPrimaryKey,
  withPrimaryKey: exports.withPrimaryKey,
};
