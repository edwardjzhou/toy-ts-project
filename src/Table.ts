...
// compile-time types (no effect on actual runtime)
type csvFileFormat = 'csv'
interface ReadableFile<FileFormat extends string> {
    path: `${any}.${Lowercase<FileFormat>}`
}
let hey: ReadableFile<csvFileFormat> = {
    path: "2.csv"
}
